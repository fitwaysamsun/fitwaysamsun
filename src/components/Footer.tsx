          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <button onClick={() => handleNavigation('/')} className="block text-left w-full text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-200">
                  Ana Sayfa
                </button>
                ...
                <button onClick={() => handleNavigation('/#videos')} className="block text-left w-full text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-200">
                  Videolar
                </button>
